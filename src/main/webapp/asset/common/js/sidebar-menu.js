...
var App = function () {
    ...
    var handleSidebarAndContentHeight = function () {
		...
		var side_menu = $('.page-sidebar-menu');
		var available_height = $(window).height() - $('#header').height()-22;
        if (content.height() <  available_height) {
            content.attr('style', 'min-height:' + available_height + 'px !important');
        } 
		side_menu.css("max-height",available_height);         
    }
    ...
    var handleSidebarMenu = function () {
        ...
        jQuery('.page-sidebar').on('click', ' li > a.ajaxify', function (e) {
                ...
                var menuContainer = jQuery('.page-sidebar');
    ...
    var _calculateFixedSidebarViewportHeight = function () {
        var sidebarHeight = $(window).height() - $('#header').height() - 2;
    ...
    var handleGoTop = function () {
        ...
        jQuery('.go-top').on('click', '.go-topbtn', function (e) {
                App.scrollTo();
                e.preventDefault();
            });
    }
