...
<body>
<div class="topfixed">
	<div class="current"><s></s><a href="${pageContext.request.contextPath}/after/content/chuangye">大学生创业政策管理</a> >> <span>编辑</span></div>
	<div class="btnbox">
...
<div class="content">
     <dl class="forms">
         ...
         <input id="categoryId" name="categoryId" value="5" type="hidden"/>
