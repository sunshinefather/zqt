...
<body>
<div class="topfixed">
		<div class="current"><s></s><a href="#">园区管理</a> >><span>历届领导班子管理</span></div>
		
		<div class="btnbox">
			<a href="${pageContext.request.contextPath}/after/content/add/lijielingdao">
...
<div class="content">
	<form action="${pageContext.request.contextPath}/after/content/banzi" method="post" id="userSearchForm" style="display: none">
		<dl class="forms" style="padding-bottom: 132px;">
			<dd>
				<label for="search_userName">历届班子：</label>
	...
	<div class="pages">
    	<pageTag:pagin totalPage="${ page.totalPages}" currentPage="${page.pageNo }" uri="${pageContext.request.contextPath}/after/content/banzi"></pageTag:pagin>
    </div>
</div>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#userListTable tbody tr td:not(.center)").live('click',function(){
			...
			location = '${pageContext.request.contextPath}/after/content/edit/'+$id+"/lijielingdao";
		});
	});
