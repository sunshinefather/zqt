...
<body>
<div class="topfixed">
		<div class="current"><s></s><a href="#">园区管理</a> >><span>政策管理</span></div>
		
		<div class="btnbox">
			<a href="${pageContext.request.contextPath}/after/content/add/zhengceguanli">
...
<div class="content">
	<form action="${pageContext.request.contextPath}/after/content/zhengce" method="post" id="userSearchForm" style="display: none">
	...
	<div class="pages">
    	<pageTag:pagin totalPage="${ page.totalPages}" currentPage="${page.pageNo }" uri="${pageContext.request.contextPath}/after/content/zhengce"></pageTag:pagin>
    </div>
</div>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#userListTable tbody tr td:not(.center)").live('click',function(){
			...
			location = '${pageContext.request.contextPath}/after/content/edit/'+$id+"/zhengceguanli";
		});
	});
